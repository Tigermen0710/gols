...
|------|-------------------------------------------------|----------------------|
|  -   | display help options or flags                   | ![image](https://i.postimg.cc/gwWXDHt9/gols-help.png) |
...
|  -m  | only show symbolik links                        | ![image](https://i.postimg.cc/nsGsw9NX/gols-help3.png) |
